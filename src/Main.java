    ...
    public static void carScanner() {
        ...
        try {
            ...
            if (loanLife <= 0 || interestRate <=0) {
                ...
                BigDecimal bd = new BigDecimal(monthlyPayment).setScale(2, RoundingMode.CEILING);
                double roundedMonthlyPayment = bd.doubleValue();
                System.out.println("Your monthly payment is " + roundedMonthlyPayment + " dollars ");
            }
